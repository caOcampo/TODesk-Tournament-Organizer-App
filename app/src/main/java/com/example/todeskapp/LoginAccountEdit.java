...
import com.example.todeskapp.databinding.LoginAccountEditBinding;
...
public class LoginAccountEdit extends AppCompatActivity{

    private LoginAccountEditBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = LoginAccountEditBinding.inflate(getLayoutInflater());
    ...
    private void loginUser(String email, String password) {
        if (email.isEmpty() || password.isEmpty()) {
            Toast.makeText(LoginAccountEdit.this, "Email and password are required fields.", Toast.LENGTH_SHORT).show();
            return;
        }
